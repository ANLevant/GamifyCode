export const URL_CONSTANTS=
{
  USERS:{
    ...
    GET_USER_BY_ID: {URL: "http://localhost:8080/users/:userId", METHOD: "GET", PARAMETERS_NAMES:[":userId"]},
    ...
    GET_ALL_USERS_LIST: {URL: "http://localhost:8080/users", METHOD: "GET"}
  },
  ROLES:{
    GET_ALL_ROLES:{URL:"http://localhost:8080/roles", METHOD:"GET"}
  }
}
